...
function getBackgroundClasses(
  ...
  switch (background) {
    ...
    case "gradient":
      return "bg-[radial-gradient(ellipse_at_top,rgba(161,0,255,0.08)_0%,transparent_60%),radial-gradient(ellipse_at_bottom_right,rgba(161,0,255,0.05)_0%,transparent_50%)]";
    case "grid":
